...
with st.sidebar:
    ...
    if st.button("🔄 One-Click Process All Data", type="primary", use_container_width=True):
        with st.spinner("Processing all data from Google Drive..."):
            try:
                ...
                # Define folder paths
                folders = {
                    'Horizon': '/content/drive/MyDrive/Distributor Sales Reports/Horizon',
                    'PSC': '/content/drive/MyDrive/Distributor Sales Reports/PSC Sales Reports',
                    'Ollie': '/content/drive/MyDrive/Distributor Sales Reports/Ollie'
                }
                ...
                if all_data:
                    ...
                    st.warning("No new files to process. All files have been processed already.")
    ...
    drive_status = "✅ Available" if os.path.exists('credentials.json') or 'GOOGLE_CREDENTIALS' in os.environ else "❌ Not configured"
